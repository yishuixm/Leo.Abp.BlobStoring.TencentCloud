...
namespace Leo.Abp.BlobStoring.TencentCloud
{
    public class TencentCloudBlobProviderConfiguration
    {
        ...
        {
            get => _containerConfiguration.GetConfigurationOrDefault<int>(TencentCloudBlobProviderConfigurationNames.ConnectionLimit);
            set => _containerConfiguration.SetConfiguration(TencentCloudBlobProviderConfigurationNames.ConnectionLimit, value);
        }
